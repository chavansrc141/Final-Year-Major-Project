...
def main():
    ...
    for pos in range(args.repeat):
        ...
        selected_bands = sio.loadmat('../results/drl_30_bands_pavia_university.mat')
        ...
        print(x_test[:,:,:])
        print(x_test[:,:,:].shape)
        x_test = x_test[:,selected_bands_array.astype(int), np.newaxis]
        # print(x_test)
        # print(x_test.shape)
        x_train = x_train[:,selected_bands_array.astype(int), np.newaxis]
# //////////////////////////////////////////////////////////code for x_train/test band selection
        
        n_bands, sequences = x_train.shape[1:]
        # print("nbands: ", n_bands)
